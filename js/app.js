function isValidCard(numberCard){
  ...
  for(var j=0;j<newArray.length;j++){//Iteración para duplicar el valor en este caso de los impares, porque empiezo de cero. Y los almaceno en un nuevo array.
...
isValidCard(question); //4083952015263//408965
 //viendo si se actualiza